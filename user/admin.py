    ...
    def add_view(self, request, form_url="", extra_context=None):
        if request.FILES.get('instructor_file'):
            ...
            if len(group)==0: #  如果教师这个Group不存在
                ...
                group.permissions.set([view_userinfo, change_userinfo, change_assignmenttemplate, view_assignmenttemplate, add_topicbatch, add_defencebatch, view_graduateprojectinfo, change_graduateprojectinfo])
